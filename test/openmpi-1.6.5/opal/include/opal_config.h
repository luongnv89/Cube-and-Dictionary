...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-DNDEBUG -g -O2 -finline-functions -fno-strict-aliasing ' CPPFLAGS=' -D_REENTRANT -I/Users/luongnv89/programming/openmpi/openmpi-1.6.5/opal/mca/hwloc/hwloc132/hwloc/include   -I/usr/include/infiniband -I/usr/include/infiniband' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --with-mpi=open_mpi --disable-aio"
...
#define OPAL_ARCH "x86_64-apple-darwin13.0.0"
...
#define OPAL_PACKAGE_STRING "Open MPI luongnv89@Nguyens-MacBook-Pro.local Distribution"
...
#define WRAPPER_EXTRA_FCFLAGS "-Wl,-commons,use_dylibs "

/* Additional FFLAGS to pass through the wrapper compilers */
#define WRAPPER_EXTRA_FFLAGS "-Wl,-commons,use_dylibs "
