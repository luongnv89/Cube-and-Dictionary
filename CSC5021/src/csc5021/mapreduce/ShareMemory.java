...
public class ShareMemory implements HasInvariant {
	...
	private static void extractFeature(Feature currentFeature) {
		...
		// Load cube
		// Utils.writeToFile("\nINFOR: Load cube data from: " +
		// ShareMemory.getCubePath());
		try {
			...
			case Feature.OXY:
				...
				extractFeatureToFile(file_name, arrayxy, ShareMemory.getCubeSize() - 1, ShareMemory.getCubeSize() - 1,
						true);
			...
			case Feature.OYZ:
				...
				extractFeatureToFile(file_name, arrayyz, ShareMemory.getCubeSize() - 1, ShareMemory.getCubeSize() - 1,
						true);
				break;
			...
			case Feature.OZX:
				...
				extractFeatureToFile(file_name, arrayzx, ShareMemory.getCubeSize() - 1, ShareMemory.getCubeSize() - 1,
						true);
				break;
			/**** ABQR ****/
			case Feature.ABQR:
